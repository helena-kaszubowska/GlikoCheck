...
1. **Ekran główny (Produkty):** nazwa i opis aplikacji, pole wyszukiwania, lista produktów, filtry poziomu IG i kategorii.
2. **Baza lokalna:** minimum 40 produktów z polami: id, nazwa, kategoria, IG, węglowodany/100 g, opis, poziom IG.
...
6. **O aplikacji:** opis IG, ŁG, interpretacji oraz komunikat medyczny.
